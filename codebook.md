...
The data set information as given in readme.txt is given below
...
Details as given in the course project:
...
* Load both train and test data sets given in course project.
* Load the features and activity labels from their respective data files.
* Extract onlly the mean and standard deviation column names and data from features as asked for the course project.
* Process the data. There are two parts processing train and test data respectively.
* Merge data set.
